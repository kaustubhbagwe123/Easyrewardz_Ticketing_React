          ...
          >
            ...
            <div className="row width">
              <div className="col-md-7">
                <div className="card store-card-padding" style={{height:"65vw"}}>
          ...
          <div className="col-md-5" style={{padding:"0"}}>
                <div className="card store-card-3">
                  ...
                  <div className="row">
                    ...
                    <ProgressBar className="logout-progress" now={70} />
                ...
                <div className="card store-card-padding-ticket">
                  ...
                  <div className="row">
                    <div className="col-md-12 store-mrg">
                      ...
                      <textarea
                        rows="8"
                        className="textarea-store-comments1"
