...
class ChatThemes extends Component {
  render() {
    ...
    const QaCrmEdit = (
      ...
      <div className="pop-over-div" style={{ marginBottom: "15px" }}>
            <label className="edit-label-1">Theme Style</label>
            <div class="custom-file">
              <input type="file" className="custom-file-input txt-edit-popover" />
