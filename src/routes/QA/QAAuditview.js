                ...
                <div className="row">
                  <div className="col-md-9">
                    ...
                    <p className="ticket-title-text-p">
                      ...
                      website of IRCTC, kindly login and click on print E
                      Ticket. The list of ticket will be shown there. If you
                      have travelled and not taken a printout then kindly search
                      you registered email ID for the ticket.
                    </p>
                  </div>
                </div>
                <div className="row msg-row" style={{ marginLeft: "20px" }}>
                  ...
                  >
                    <a href={Demo.BLANK_LINK}>
                      <label className="messages-04-new-text">
                        Messages: 04
                      </label>
                    </a>
                  </div>
                  ...
                  <Accordion defaultActiveKey="0">
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="0">
                        <Card.Body>
                          <div>
                            <div className="row collapsebutton mt-2">
                              <div className="yenowi">
                                <label className="collapse-text-1">
                                  Opening Procedure
                                </label>
                              </div>
                              <div className="yenowi1">
                                <div
                                  className="btn-group"
                                  id="status"
                                  data-toggle="buttons"
