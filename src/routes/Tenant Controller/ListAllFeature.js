                  ...
                  <div className="CenterPlan tooltipcenterplan">
                    ...
                    <div className="row m-t-10">
                      <div className="col-md-12">
                        ...
                        <input type="textarea" className="txt-1tooltip" 
                        placeholder="Lorem ipsum is simply dummytext of<br>printing and type setting
        ...
        const data = [
            {
              ...
              Tool: (
                  <label>Which form is required Grammatically but which contribute<br></br>
                  Which form is required Grammatically.</label>
              )
            ...
            },
            {
              ...
              Tool: (
                <label>Which form is required Grammatically but which contribute which</label>
                )
