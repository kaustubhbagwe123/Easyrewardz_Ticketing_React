                        ...
                        <tr>
                            <td style={{ width: "50%" }}>
                                ...
                                <div className="row rowmargin">
                                    <div className="col-md-6">
                                        <select className="category-select">
                                            <option className="select-category-placeholder" selected>
                                                Select Category
                          </option>
                                        </select>
                                    </div>
                                ...
                                <div className="row rowmargin">
                                    ...
                                    <div className="col-md-6">
                                        <label className="sub-category">Ticket Priority</label>
                                    </div>
                                </div>
                                ...
                                </div>
                                {
                                    ...
                                    this.state.showAddNote ?
                                        <div className="row rowmargin" style={{ marginLeft: "26px", marginTop: "14px" }}>
                                            <textarea className="addNote-textarea" placeholder="Write your note here"></textarea>
                                        </div> : null
                            ...
                            <td className="rectangletd" style={{ width: "45%" }}>
                                ...
                                <div className="row">
                                    <div className="col-md-4">
                                        <label className="alankrit-kumar">Alankrit Kumar</label>
                                    </div>
                                    <div className="col-md-4">
                                        <label className="b91-9873470074">+91-9873470074</label>
                                    </div>
                                    <div className="col-md-4">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-4">
                                        <label className="phone-number">Alternate Number</label>
                                    </div>
                                    <div className="col-md-4">
