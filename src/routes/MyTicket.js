              ...
              <div className="rectangle-3">
                ...
                <div className="row">
                  <label className="label-3">
                    ...
                    details of which of your friends have joined, which friends
                    have transacted etc. on the same tab.
                  </label>
                </div>
                <div className="row">
                  <div className="mask1">
                ...
                <div className="row top-margin">
                  <div className="col-md-4">
                    <div className="row">
                      ...
                      <label className="solved-by-naman-r" style={{marginLeft:"7px"}}>
                        Solved by NamanR
                      </label>
                      <img src={MsgImg} alt="right" className="smg-Img" style={{marginLeft:"95px"}} />
                    </div>
                  </div>
                  <div className="col-md-6">
                ...
                >
                  ...
                  <div className="col-xs-9">
                    <label className="rashmi-c">
                      Rashmi.C
                      <span>
                        <label className="updated-2-d-ago">Reassign to <label style={{ fontWeight: "bold",color:"black" }}> Naman.R</label></label>{" "}
