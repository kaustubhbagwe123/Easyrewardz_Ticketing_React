...
class MyTicketAll extends Component {
  constructor(props) {
    super(props);
  ...
  checkAllCheckbox(event) {
    ...
    var checkboxes = document.getElementsByName("MyTicketListAlcheckbox[]");
            ...
            <div className="filter-type pink1 pinkmyticket">
              <div className="filter-checkbox pink2 pinkmargin">
                <input
                  type="checkbox"
                  id="fil-al1"
                  name="MyTicketListAlcheckbox[]"
                />
                <label htmlFor="fil-al1">
                  <img
                    src={HeadPhone3}
                    alt="HeadPhone"
          ...
          <span>
            <div className="filter-type pink1 pinkmyticket">
              <div className="filter-checkbox pink2 pinkmargin">
                ...
                />
                <label htmlFor="fil-Alall" className="ticketid">
                  ID
                </label>
              </div>
            </div>
                    ...
                    <div className="myticlist-expand-sect">
                      ...
                      <div className="tab-content p-0">
                        ...
                        <div
                          ...
                          id="customer-tabAl"
                          role="tabpanel"
                          aria-labelledby="customer-tabAl"
                        >
                          <div className="container-fluid">
                            <div className="row">
                              <div className="col-md-3 col-sm-6">
                        ...
                        <div
                          ...
                          id="category-tabAl"
                          role="tabpanel"
                          aria-labelledby="category-tabAl"
                        >
                          <div className="container-fluid">
                            <div className="row">
                              <div className="col-md-3 col-sm-6">
