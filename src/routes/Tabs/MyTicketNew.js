...
class MyTicketNew extends Component {
  constructor(props) {
    super(props);
  ...
  checkAllCheckbox(event) {
    ...
    var checkboxes = document.getElementsByName("MyTicketListNewcheckbox[]");
            ...
            <div className="filter-type pink1 pinkmyticket">
              <div className="filter-checkbox pink2 pinkmargin">
                <input
                  type="checkbox"
                  id="fil-new1"
                  name="MyTicketListNewcheckbox[]"
                />
                <label htmlFor="fil-new1">
                  <img
                    src={HeadPhone3}
                    alt="HeadPhone"
          ...
          <span>
            <div className="filter-type pink1 pinkmyticket">
              <div className="filter-checkbox pink2 pinkmargin">
                ...
                />
                <label htmlFor="fil-newall" className="ticketid">
                  ID
                </label>
              </div>
            </div>
                            ...
                            <div className="myticlist-expand-sect">
                                ...
                                <ul className="nav nav-tabs" role="tablist">
                                  ...
                                  <li className="nav-item">
                                    <a
                                      className="nav-link"
                                      data-toggle="tab"
                                      href="#customer-tabNew"
                                      role="tab"
                                      aria-controls="customer-tabNew"
                                      aria-selected="false"
                                    >
                                      By Customer Type
                                    </a>
                                  ...
                                  <li className="nav-item">
                                    <a
                                      className="nav-link"
                                      data-toggle="tab"
                                      href="#category-tabNew"
                                      role="tab"
                                      aria-controls="category-tabNew"
                                      aria-selected="false"
                                    >
                                      By Category
                                    </a>
                              ...
                              <div className="tab-content p-0">
                                ...
                                <div
                                  ...
                                  id="customer-tabNew"
                                  role="tabpanel"
                                  aria-labelledby="customer-tabNew"
                                >
                                  <div className="container-fluid">
                                    <div className="row">
                                      <div className="col-md-3 col-sm-6">
                                ...
                                <div
                                  ...
                                  id="category-tabNew"
                                  role="tabpanel"
                                  aria-labelledby="category-tabNew"
                                >
                                  <div className="container-fluid">
                                    <div className="row">
                                      <div className="col-md-3 col-sm-6">
