...
class MyTicketResolved extends Component {
  constructor(props) {
    super(props);
            ...
            <div className="filter-type pink1 pinkmyticket">
              <div className="filter-checkbox pink2 pinkmargin">
                <input
                  type="checkbox"
                  id="fil-Res1"
                  name="MyTicketListResolvedcheckbox[]"
                />
                <label htmlFor="fil-Res1">
                  <img
                    src={HeadPhone3}
                    alt="HeadPhone"
          ...
          <span>
            <div className="filter-type pink1 pinkmyticket">
              <div className="filter-checkbox pink2 pinkmargin">
                ...
                />
                <label htmlFor="fil-Resall" className="ticketid">
                  ID
                </label>
              </div>
            </div>
                    ...
                    <div className="myticlist-expand-sect">
                        ...
                        <ul className="nav nav-tabs" role="tablist">
                          ...
                          <li className="nav-item">
                            <a
                              className="nav-link"
                              data-toggle="tab"
                              href="#customer-tabRes"
                              role="tab"
                              aria-controls="customer-tabRes"
                              aria-selected="false"
                            >
                              By Customer Type
                            </a>
                          ...
                          <li className="nav-item">
                            <a
                              className="nav-link"
                              data-toggle="tab"
                              href="#category-tabRes"
                              role="tab"
                              aria-controls="category-tabRes"
                              aria-selected="false"
                            >
                              By Category
                            </a>
                      ...
                      <div className="tab-content p-0">
                        ...
                        <div
                          ...
                          id="customer-tabRes"
                          role="tabpanel"
                          aria-labelledby="customer-tabRes"
                        >
                          <div className="container-fluid">
                            <div className="row">
                              <div className="col-md-3 col-sm-6">
                        ...
                        <div
                          ...
                          id="category-tabRes"
                          role="tabpanel"
                          aria-labelledby="category-tabRes"
                        >
                          <div className="container-fluid">
                            <div className="row">
                              <div className="col-md-3 col-sm-6">
...
export default MyTicketResolved;
