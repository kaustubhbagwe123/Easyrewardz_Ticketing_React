        ...
        >
          ...
          <div style={{ padding: "20px 8px 0px 8px" }}>
            <input
              ...
              maxLength="100"
            />
            {this.state.taskTitle.length == 0 && <p style={{ 'color' : 'red', 'margin-bottom' : '0px' }}>{this.state.taskTitleCompulsion}</p>}
            <textarea
              ...
              maxLength="250"
            ></textarea>
            {this.state.taskDescription.length == 0 && <p style={{ 'color' : 'red', 'margin-bottom' : '0px' }}>{this.state.taskDescCompulsion}</p>}
            <div className="row m-t-15">
              <div className="col-md-6">
                ...
                {this.state.selectedDepartment.length == 0 && <p style={{ 'color' : 'red', 'margin-bottom' : '0px' }}>{this.state.taskDepartmentCompulsion}</p>}
              </div>
              <div className="col-md-6">
                <select
                  name="Function"
                ...
                {this.state.selectedFunction.length == 0 && <p style={{ 'color' : 'red', 'margin-bottom' : '0px' }}>{this.state.taskFunctionCompulsion}</p>}
              </div>
            </div>
            <div className="row m-t-15">
              <div className="col-md-6">
                ...
                {this.state.selectedAssignTo.length == 0 && <p style={{ 'color' : 'red', 'margin-bottom' : '0px' }}>{this.state.taskAssignToCompulsion}</p>}
              </div>
              <div className="col-md-6">
                <select
                  name="Priority"
                ...
                {this.state.selectedPriority.length == 0 && <p style={{ 'color' : 'red', 'margin-bottom' : '0px' }}>{this.state.taskPriorityCompulsion}</p>}
              </div>
            </div>
