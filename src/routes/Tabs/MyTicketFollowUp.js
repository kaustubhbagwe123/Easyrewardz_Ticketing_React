...
class MyTicketFollowUp extends Component {
  constructor(props) {
    super(props);
  ...
  checkAllCheckbox(event) {
    ...
    var checkboxes = document.getElementsByName("MyTicketListFollowcheckbox[]");
            ...
            <div className="filter-type pink1 pinkmyticket">
              <div className="filter-checkbox pink2 pinkmargin">
                <input
                  type="checkbox"
                  id="fil-Follow1"
                  name="MyTicketListFollowcheckbox[]"
                />
                <label htmlFor="fil-Follow1">
                  <img
                    src={HeadPhone3}
                    alt="HeadPhone"
          ...
          <span>
            <div className="filter-type pink1 pinkmyticket">
              <div className="filter-checkbox pink2 pinkmargin">
                ...
                />
                <label htmlFor="fil-Followall" className="ticketid">
                  ID
                </label>
              </div>
            </div>
                    ...
                    <div className="myticlist-expand-sect">
                        ...
                        <ul className="nav nav-tabs" role="tablist">
                          ...
                          <li className="nav-item">
                            <a
                              className="nav-link"
                              data-toggle="tab"
                              href="#customer-tabFoll"
                              role="tab"
                              aria-controls="customer-tabFoll"
                              aria-selected="false"
                            >
                              By Customer Type
                            </a>
                          ...
                          <li className="nav-item">
                            <a
                              className="nav-link"
                              data-toggle="tab"
                              href="#category-tabFoll"
                              role="tab"
                              aria-controls="category-tabFoll"
                              aria-selected="false"
                            >
                              By Category
                            </a>
                      ...
                      <div className="tab-content p-0">
                        ...
                        <div
                          ...
                          id="customer-tabFoll"
                          role="tabpanel"
                          aria-labelledby="customer-tabFoll"
                        >
                          <div className="container-fluid">
                            <div className="row">
                              <div className="col-md-3 col-sm-6">
                        ...
                        <div
                          ...
                          id="ticket-tabFoll"
                          role="tabpanel"
                          aria-labelledby="ticket-tabFoll"
                        >
                          <div className="container-fluid">
                            <div className="row">
                              <div className="col-md-3 col-sm-6">
                        ...
                        <div
                          ...
                          id="category-tabFoll"
                          role="tabpanel"
                          aria-labelledby="category-tabFoll"
                        >
                          <div className="container-fluid">
                            <div className="row">
                              <div className="col-md-3 col-sm-6">
...
export default MyTicketFollowUp;
