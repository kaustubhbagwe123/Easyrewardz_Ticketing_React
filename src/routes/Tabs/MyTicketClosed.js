...
class MyTicketClosed extends Component {
  ...
  checkAllCheckbox(event) {
    ...
    var checkboxes = document.getElementsByName("MyTicketListClosecheckbox[]");
            ...
            <div className="filter-type pink1 pinkmyticket">
              <div className="filter-checkbox pink2 pinkmargin">
                <input
                  type="checkbox"
                  id="fil-close1"
                  name="MyTicketListClosecheckbox[]"
                />
                <label htmlFor="fil-close1">
                  <img
                    src={HeadPhone3}
                    alt="HeadPhone"
          ...
          <span>
            <div className="filter-type pink1 pinkmyticket">
              <div className="filter-checkbox pink2 pinkmargin">
                ...
                />
                <label htmlFor="fil-closeall" className="ticketid">
                  ID
                </label>
              </div>
            </div>
                    ...
                    <div className="myticlist-expand-sect">
                        ...
                        <ul className="nav nav-tabs" role="tablist">
                          ...
                          <li className="nav-item">
                            <a
                              className="nav-link"
                              data-toggle="tab"
                              href="#customer-tabClose"
                              role="tab"
                              aria-controls="customer-tabClose"
                              aria-selected="false"
                            >
                              By Customer Type
                            </a>
                          ...
                          <li className="nav-item">
                            <a
                              className="nav-link"
                              data-toggle="tab"
                              href="#ticket-tabClose"
                              role="tab"
                              aria-controls="ticket-tabClose"
                              aria-selected="false"
                            >
                              By Ticket Type
                            </a>
                          ...
                          <li className="nav-item">
                            <a
                              className="nav-link"
                              data-toggle="tab"
                              href="#category-tabClose"
                              role="tab"
                              aria-controls="category-tabClose"
                              aria-selected="false"
                            >
                              By Category
                            </a>
                      ...
                      <div className="tab-content p-0">
                        ...
                        <div
                          ...
                          id="customer-tabClose"
                          role="tabpanel"
                          aria-labelledby="customer-tabClose"
                        >
                          <div className="container-fluid">
                            <div className="row">
                              <div className="col-md-3 col-sm-6">
                        ...
                        <div
                          ...
                          id="ticket-tabClose"
                          role="tabpanel"
                          aria-labelledby="ticket-tabClose"
                        >
                          <div className="container-fluid">
                            <div className="row">
                              <div className="col-md-3 col-sm-6">
                        ...
                        <div
                          className="tab-pane fade"
                          id="category-tabClose"
                          role="tabpanel"
                          aria-labelledby="category-tabClose"
                        >
                          <div className="container-fluid">
                            <div className="row">
                              <div className="col-md-3 col-sm-6">
