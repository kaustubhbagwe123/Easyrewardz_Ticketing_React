...
class KnowledgeBase extends Component {
  ...
  constructor(props) {
                       ...
                       this.HandelFirstTabClick = this.HandelFirstTabClick.bind(
                         this
                       );
                       this.HandelSecoundTabClick = this.HandelSecoundTabClick.bind(
                         this
                       );
  ...
  HandelFirstTabClick() {
    this.setState({ headerfirst: "block", headersecound: "none" ,detailscollapse: false,tabcolor:"#2561A8",tabcolor1:"#4A4A4A"});
  }

  HandelSecoundTabClick() {
    this.setState({ headerfirst: "none", headersecound: "block" ,detailscollapse: false,tabcolor:"#4A4A4A",tabcolor1:"#2561A8"});
  }
          ...
          <div className="kb-header">
            <div>
              <a href={Demo.BLANK_LINK} onClick={this.HandelFirstTabClick}>
                <label className="header-new-submissions" style={{color:this.state.tabcolor}}>
                  New Submissions
                </label>
              </a>
              <a href={Demo.BLANK_LINK} onClick={this.HandelSecoundTabClick}>
                <label className="header-new-submissions-1" style={{color:this.state.tabcolor1}}>
                  Knowledge Base List
                </label>
              </a>
              <button
                ...
                <table className="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p className="table-details-data" style={{display:"block"}}>
                          Can I purchase a domain through Google?
                        </p>
                        <p className="table-details-data-1">
                          Google can help you purchase a domain through one of
                          our domain host partners. During sign up, just select
                          the option to…
                        </p>
                        <img
                          src={DownArrowIcon}
                          ...
                          <Card>
                            <CardBody>
                              <p className="table-details-data-1">
                                ...
                                using any previous version of Sites, there will
                                be no disruption. Keep editing and sharing your
                                Sites as youIf your company is using any
                                previous version of Sites, there will be no
                                disruption. Keep editing and sharing your Sites
                                as you If your company is using any previous
                                version of Sites,
                              </p>
                            </CardBody>
                          </Card>
            ...
            <div>
              <div className="kb-Model-mp">
                ...
                <div className="row">
                  ...
                  <div>
                    <select className="add-select-subcategory">
              ...
              /> */}
                  ...
                  <textarea className="rich-text-areas"></textarea>
                </div>
                <br />
