                ...
                <section className="dash-cntr">
                    ...
                    <div className="table-cntr mt-3">
                        ...
                        <thead>
                            <tr>
                            <th>ID</th>
                            <th>Status <img src="Images/table-arr.png" alt="image missing" /></th>
                            <th className="table-img-cntr"></th>
                            <th>Subject<span>/Lastest Message</span></th>
                            <th>Category <img src="Images/table-arr.png" alt="image missing" /></th>
                            <th>Priority <img src="Images/table-arr.png" alt="image missing" /></th>
                            <th>Assignee <img src="Images/table-arr.png" alt="image missing" /></th>
                            <th>Creation on <img src="Images/table-arr.png" alt="image missing" /></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <td>Defective article <img className="info-icon" src="Images/info-icon.png" alt="image missing" /></td>
                            <td>High</td>
                            <td>N Rampal</td>
                            <td>2 Hour Ago <img className="info-icon" src="Images/info-icon.png" alt="image missing" /></td>
                            </tr>
                            ...
                            <td>High</td>
                            <td>N Rampal</td>
                            <td>12 March 2018 <img className="info-icon" src="Images/info-icon.png" alt="image missing" /></td>
                            </tr>
                            <tr className="blue-bg">
                            <td>ABC1234</td>
                            <td><span className="table-btn table-yellow-btn">New</span></td>
                            <td className="table-img-cntr"><img className="task-icon-1" src="Images/task-icon-blue.png" alt="image missing" /></td>
                            ...
                            <td>ABC1234</td>
                            <td><span className="table-btn table-yellow-btn">New</span></td>
                            <td className="table-img-cntr"><img className="task-icon-1" src="Images/task-icon-gray.png" alt="image missing" /></td>
                            <td>Need to change my shipping address <span>Hope this help, Please rate us</span></td>
                            <td>Defective article <img className="info-icon" src="Images/info-icon.png" alt="image missing" /></td>
                            <td>High</td>
                            <td>N Rampal</td>
                            ...
                            <td className="table-img-cntr"><img className="claim-icon" src="Images/cliam-icon-blue.png" alt="image missing" /><img className="task-icon-1" src="Images/task-icon-gray.png" alt="image missing" /></td>
                            <td>Need to change my shipping address <span>Hope this help, Please rate us</span></td>
                            <td>Defective article <img className="info-icon" src="Images/info-icon.png" alt="image missing" /></td>
                            <td>High</td>
                            <td>N Rampal</td>
